...
if ($search !== '') {
    $search_sql = "WHERE m.nama LIKE ? OR s.id_sempro LIKE ? OR m.nim LIKE ?";
    $params[] = "%$search%";
    $params[] = "%$search%";
    $params[] = "%$search%";
}
...
<head>
    ...
    <title>Daftar Pengajuan Seminar Proposal</title>
...
.avatar{
    ...
    justify-content:center;
        ...
        .btn-nilai { background-color: #10B981; }
            ...
            <tbody>
                ...
                <?php else: 
                    ...
                    foreach ($pengajuan_list as $p):
                        ...
                        $tanggal_sempro = $p['tanggal_sempro']
                            ? date('d M Y', strtotime($p['tanggal_sempro']))
                            : '-';
                ?>
                    <tr>
                        <td><?= $no++ ?></td>
                        ...
                        <td>
                            <div class="btn-grid">
                                ...
                                <?php if (($p['status'] ?? '') === 'disetujui'): ?>
                                    ...
                                    <a href="input_nilai_sempro.php?pengajuan_id=<?= $p['id'] ?>" class="btn-action btn-nilai">Input Nilai</a>
                                <?php else: ?>
